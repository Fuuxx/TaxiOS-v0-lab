...
function SectionHeader({
  ...
  return (
    <div className="flex flex-col gap-4 border-[var(--taxis-workspace-surface-rim)] border-b pb-5 md:flex-row md:items-start md:justify-between">
      <div>
        <span className="font-semibold text-[10px] text-[var(--taxis-workspace-text-muted)] uppercase tracking-[0.16em]">
          Einstellungen
        </span>
      ...
      {editable ? (
        ...
        <span className="inline-flex min-h-9 items-center rounded-[12px] border border-[var(--taxis-workspace-surface-rim)] bg-[var(--taxis-workspace-surface-soft)] px-3 font-semibold text-[11px] text-[var(--taxis-workspace-text-muted)] uppercase tracking-[0.12em]">
          {copy.readOnlyLabel}
        </span>
      )}
      ...
      {actions.map((action) => {
        ...
        const content = (
          <>
            ...
            {action.disabled ? (
              <span className="rounded-[10px] bg-[var(--taxis-workspace-surface-soft)] px-2.5 py-1 font-semibold text-[10px] text-[var(--taxis-workspace-text-muted)] uppercase tracking-[0.12em]">
                Gesperrt
              </span>
            ) : (
              <Check
