...
function FinanceSummaryTile({
  ...
  return (
    <WorkspaceSurface className="taxis-company-surface-section taxis-company-summary-tile p-5">
      <span className="block font-semibold text-[10px] text-[var(--taxis-workspace-text-muted)] uppercase tracking-[0.16em]">
        {label}
      </span>
...
function EmptyState({
  ...
  return (
    <div className="taxis-company-surface-empty px-5 py-7">
