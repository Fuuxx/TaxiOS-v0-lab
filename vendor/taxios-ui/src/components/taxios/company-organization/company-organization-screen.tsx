...
function EmptyState({
  ...
  return (
    <WorkspaceInnerCard className="flex min-h-[132px] items-center gap-4 p-6">
      <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[var(--taxis-workspace-accent-soft)] text-[var(--taxis-workspace-accent-strong)]">
        <UsersRound aria-hidden="true" size={20} strokeWidth={1.9} />
      </span>
      <div className="min-w-0 text-left">
        <h3 className="font-semibold text-[16px] text-[var(--taxis-workspace-text-strong)] tracking-tight">
          {title}
        </h3>
...
const headerCellClassName =
  "taxis-workspace-table-header-cell taxios-company-organization-header-cell border-y px-4 py-3 font-semibold text-[10px] uppercase tracking-[0.15em] first:rounded-l-[16px] first:border-l last:rounded-r-[16px] last:border-r";
...
function CompanyOrganizationSectionNavigation({
  ...
  return (
    ...
    >
      {companyOrganizationSectionOrder
    ...
    >
      ...
      >
        ...
        <div className="taxis-workspace-scrollbar flex-1 space-y-6 overflow-y-auto px-6 pt-6 pb-7">
          ...
          {error ? (
            <WorkspaceInnerCard className="p-5 text-[13px] text-red-700">
              {error}
            </WorkspaceInnerCard>
          ) : null}
          ...
          {detail ? (
            <>
              ...
              <section>
                <h4 className="mb-3 flex items-center gap-2 font-semibold text-[11px] text-[var(--taxis-workspace-text-muted)] uppercase tracking-[0.16em]">
                  <History size={14} />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 mt-5 min-h-0 flex-1 overflow-y-auto px-5 pb-5 md:px-6 md:pb-6">
          {activeForm ?? null}
        </div>
      </div>
    </div>
              ...
              >
                ...
                <td className={bodyCellClassName}>
                  ...
                  {row.emailDeliveryError ? (
                    <span className="mt-1 block max-w-xs text-[11px] text-red-700 leading-snug">
                      {row.emailDeliveryError}
                    </span>
                  ) : null}
                </td>
