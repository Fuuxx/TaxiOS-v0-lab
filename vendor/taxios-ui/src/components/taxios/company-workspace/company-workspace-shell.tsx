...
function buildWorkspaceInitials(label: string) {
  const parts = label
    .split(/\s+/)
    ...
    <aside className="relative z-20 hidden w-[clamp(292px,16vw,344px)] shrink-0 flex-col p-[clamp(1.5rem,1.25vw,1.75rem)] pr-0 xl:flex">
      <CompanyWorkspaceSurface className="taxis-workspace-sidebar-shell flex h-full flex-col overflow-hidden">
        ...
        <div className="taxis-workspace-sidebar-footer mt-auto">
          ...
          <div className="taxis-workspace-account-card group mt-3 flex w-full cursor-pointer items-center gap-3 text-left">
            <CompanyDashboardAvatar
              className="h-10 w-10 shrink-0"
              initials={buildWorkspaceInitials(organizationName)}
...
function CompanyWorkspaceUserMenu({
  ...
  return (
    <details className="group relative shrink-0">
      ...
      <div className="absolute top-[calc(100%+0.75rem)] right-0 z-50 w-[24rem] max-w-[calc(100vw-2rem)] overflow-hidden rounded-[22px] border border-[var(--taxis-workspace-border)] bg-white/96 p-2 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.58)] backdrop-blur-xl">
        ...
        <div className="grid gap-1 py-2">
          <details className="taxis-user-profile-details">
            <summary className="taxis-user-profile-summary flex min-h-10 cursor-pointer list-none items-center gap-2 rounded-[13px] px-3 font-semibold text-[12px] text-[var(--taxis-workspace-text-secondary)] transition-colors hover:bg-[var(--taxis-workspace-surface-soft)] hover:text-[var(--taxis-workspace-text-primary)]">
            ...
            <div className="taxis-user-profile-panel mt-1 rounded-[18px] border border-[var(--taxis-workspace-surface-rim)] bg-[var(--taxis-workspace-surface)] p-3">
